...
function update(){integrate();for(var a=updating(),b=0;b<steps;b++){a&&b+5<steps&&mouseOffset();for(var c=0;8>c;c++)solveConstraints(c)}for(a=0;6>a;a++)computeVertexNormals(a)}var RESOLUTION$1,mesh$1;
...
"vec3 transformed = texture2D( tPosition, position.xy ).xyz;")};for(var d=new Float32Array(RESOLUTION$1*RESOLUTION$1*3),e=0,f=RESOLUTION$1*RESOLUTION$1;e<f;e++){var g=3*e;d[g+0]=e%RESOLUTION$1/RESOLUTION$1+.5/RESOLUTION$1;d[g+1]=~~(e/RESOLUTION$1)/RESOLUTION$1+.5/RESOLUTION$1}e=new THREE.BufferGeometry;e.setIndex(geometry.index);e.addAttribute("position",new THREE.BufferAttribute(d,3));e.addAttribute("uv",geometry.attributes.uv);mesh$1=new THREE.Mesh(e,b);mesh$1.customDepthMaterial=c;mesh$1.castShadow=
!0;a.add(mesh$1)}var objects,clock$1=new THREE.Clock;
function init$4(a){var b=new THREE.AmbientLight(16777215,0);b.baseIntensity=.5;var c=new THREE.SpotLight(16616331,0,4E3,Math.PI/6,.2,.11);c.baseIntensity=3.6;c.position.set(.9,.1,-.5).multiplyScalar(400);c.castShadow=!0;c.shadow.radius=20;c.shadow.camera.far=4E3;c.shadow.mapSize.height=4096;c.shadow.mapSize.width=4096;var d=new THREE.SpotLight(4882408,0,4E3,Math.PI/6,.2,.11);d.baseIntensity=2;d.position.set(-.91,.1,-.5).multiplyScalar(400);d.castShadow=!0;d.shadow.radius=20;d.shadow.camera.far=4E3;
d.shadow.mapSize.height=4096;d.shadow.mapSize.width=4096;var e=new THREE.SpotLight(16777215,0,4E3,Math.PI/5.5,1.4,.08);e.baseIntensity=1.5;e.position.set(0,0,-1).multiplyScalar(400);e.castShadow=!0;e.shadow.radius=5;e.shadow.camera.far=4E3;e.shadow.mapSize.height=4096;e.shadow.mapSize.width=4096;var f=new THREE.DirectionalLight(16777215,0);f.baseIntensity=.3;f.position.set(0,1,.5);var g=new THREE.DirectionalLight(16777215,0);g.baseIntensity=1.3;g.position.set(0,1,-.4);a.add(b,c,d,e,f,g);objects=[b,
