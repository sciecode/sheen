...
function init$4(a){var b=new THREE.AmbientLight(15663078,0);b.baseIntensity=.9;var c=new THREE.SpotLight(16616331,0,4E3,Math.PI/6,.2,.11);c.baseIntensity=2.6;c.position.set(.9,.1,-.5).multiplyScalar(400);c.castShadow=!0;c.shadow.radius=20;c.shadow.camera.far=4E3;c.shadow.mapSize.height=4096;c.shadow.mapSize.width=4096;var d=new THREE.SpotLight(7043828,0,4E3,Math.PI/6,.2,.11);d.baseIntensity=2.6;d.position.set(-.91,.1,-.5).multiplyScalar(400);d.castShadow=!0;d.shadow.radius=20;d.shadow.camera.far=
4E3;d.shadow.mapSize.height=4096;d.shadow.mapSize.width=4096;var e=new THREE.SpotLight(16777215,0,4E3,Math.PI/5.5,1.4,.08);e.baseIntensity=1;e.position.set(0,0,-1).multiplyScalar(400);e.castShadow=!0;e.shadow.radius=5;e.shadow.camera.far=4E3;e.shadow.mapSize.height=4096;e.shadow.mapSize.width=4096;var f=new THREE.DirectionalLight(16777215,0);f.baseIntensity=.6;f.position.set(0,1,-.2);a.add(b,c,d,e,f);objects=[b,c,d,e,f]}
function update$1(){var a=clock.getElapsedTime();if(1<a&&4>a)for(var b=0;b<objects.length;b++){var c=objects[b],d=objects[b].baseIntensity;var e=(a-1)/3;var f=1>(e/=.5)?.5*e*e*e:.5*((e-=2)*e*e+2);c.intensity=d*f}}var renderer$1,camera$2,scene$1;
