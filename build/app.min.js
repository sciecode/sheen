...
function update(){integrate();for(var a=0;a<steps;a++){updating()&&a+5<steps&&mouseOffset();for(var b=0;8>b;b++)solveConstraints(b)}for(a=0;6>a;a++)computeVertexNormals(a)}var RESOLUTION$1,mesh$1;
