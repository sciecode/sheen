...
mesh$1;
function init$3(a){RESOLUTION$1=Math.ceil(Math.sqrt(vertices.length));var b=(new THREE.TextureLoader).load("../../assets/Leather_007_DISP.PNG");b=new THREE.MeshPhysicalMaterial({color:16767520,bumpMap:b,bumpScale:.25,metalness:.1,roughness:.6,clearCoat:.8,clearCoatRoughness:.35,dithering:!0});b.onBeforeCompile=function(a){a.uniforms.tPosition={value:positionRT.texture};a.uniforms.tNormal={value:normalsRT.texture};a.vertexShader="uniform sampler2D tPosition;\nuniform sampler2D tNormal;\n"+a.vertexShader;a.vertexShader=
